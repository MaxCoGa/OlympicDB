...
public class LoginValidate {
 ...
 public boolean validateUserLogin(int id, String psw){
  boolean flag = false;
  Connection con = null;
  try{
   ...
   if(con != null){
    ...
    String qry = "SELECT * FROM employee WHERE eid = "+id+" AND psw = '"+psw+"' ";
 ...
 public Connection createConnection() {
  ...
  try {
   ...
   connection = DriverManager.getConnection("jdbc:postgresql://localhost:5432/postgres","postgres","CSI2532");
